...
def merge_sort(linked_list):
    ...
    -Recusively divide the linked list into sublist containing a single node
    -Repeatedly merg the sublists to produce sorted sublists until one remains

    Returns a sorted linked list
    """

    if linked_list is None or linked_list.size() == 1:
        return linked_list
...
def split(linked_list):
    """
    Divide the unsorted list at midpoint into a sublist
    """

    if linked_list == 0 or linked_list.head == None:
        ...
        mid_node = linked_list.node_next_index(mid - 1)
        left_half = linked_list
